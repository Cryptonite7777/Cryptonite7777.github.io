...
categories: [Reversing, GameHacking]
tags: [Direct3D9, D3D9, WallHack, Chams, Wireframe, ZBuffer, DrawIndexedPrimitive, Hooking]
comments: true
---
...
- [게임핵의 원리 (1) - OpenGL 기반 WallHack](https://cryptonite7777.github.io/posts/openGL-01/)
...
<img src="assets/img/GameHacking/DirectX/Dll.png" width="95%" style="display:block; margin:0 auto;">
*Dll Injection*
...
<img src="assets/img/GameHacking/DirectX/createdevice.png" width="100%" style="display:block; margin:0 auto;">
*CreateDevice*
...
<img src="assets/img/GameHacking/DirectX/subfunc.png" width="100%" style="display:block; margin:0 auto;">
*Sub Function*
...
<img src="assets/img/GameHacking/DirectX/vftable.png" width="100%" style="display:block; margin:0 auto;">
*VTable access*
...
<img src="assets/img/GameHacking/DirectX/dip.png" width="100%" style="display:block; margin:0 auto;">
*DIP*
...
<img src="assets/img/GameHacking/DirectX/trampoline.png" width="100%" style="display:block; margin:0 auto;">
*Detours*
...
<div style="display:flex; gap:10px;">
    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/DirectX/hookbefore.png" width="100%">
        <p><em>Before</em></p>
    </div>

    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/DirectX/hookafter.png" width="100%">
        <p><em>After</em></p>
    </div>
</div>
...
<div style="display:flex; gap:10px;">
    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/DirectX/ZBTRUE.png" width="100%">
        <p><em>Before</em></p>
    </div>

    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/DirectX/ZBFALSE.png" width="100%">
        <p><em>After</em></p>
    </div>
</div>
...
<img src="assets/img/GameHacking/DirectX/Logger.png" width="100%" style="display:block; margin:0 auto;">
*Stride Logger*
...
<img src="assets/img/GameHacking/DirectX/Chams.png" width="100%" style="display:block; margin:0 auto;">
*Chams*
...
<div style="display:flex; gap:10px;">
    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/DirectX/wf1.png" width="100%">
        <p><em>Wireframe</em></p>
    </div>

    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/DirectX/wf2.png" width="100%">
        <p><em>Wireframe</em></p>
    </div>
</div>
