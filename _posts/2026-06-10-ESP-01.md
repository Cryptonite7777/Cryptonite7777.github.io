...
tags: [ESP, ExternalOverlay, Direct3D9, WorldToScreen, ViewMatrix, EntityList]
comments: true
---
...
- [게임핵의 원리 (2) - Direct3D 기반 WallHack](https://cryptonite7777.github.io/posts/DirectX-01/)
...
<img src="assets/img/GameHacking/ESP/ESPall.jpg" width="100%" style="display:block; margin:0 auto;">
*ESP*
...
<div style="display:flex; gap:10px;">
    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/ESP/Controller.png" width="100%">
        <p><em>Controller</em></p>
    </div>

    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/ESP/Pawn.png" width="100%">
        <p><em>Pawn</em></p>
    </div>
</div>
...
<img src="assets/img/GameHacking/ESP/ViewFrustum.png" width="80%" style="display:block; margin:0 auto;">
*View Frustum*
...
<div style="display:flex; gap:10px;">
    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/ESP/parallel.png" width="100%">
        <p><em>parallel(평행)</em></p>
    </div>

    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/ESP/perspective.png" width="100%">
        <p><em>perspective(원근)</em></p>
    </div>
</div>
...
<div style="display:flex; gap:10px;">
    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/ESP/ESPname.jpg" width="100%">
        <p><em>Name</em></p>
    </div>

    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/ESP/ESPhealth.jpg" width="100%">
        <p><em>Health</em></p>
    </div>
</div>
...
<div style="display:flex; gap:10px;">
    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/ESP/ESPboneLogger.jpg" width="100%">
        <p><em>Bone Logger</em></p>
    </div>

    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/ESP/ESPskeleton.jpg" width="100%">
        <p><em>Skeleton</em></p>
    </div>
</div>
...
<img src="assets/img/GameHacking/ESP/ESPbox.jpg" width="100%" style="display:block; margin:0 auto;">
*2D Box*
...
<img src="assets/img/GameHacking/ESP/ESPsnapline.jpg" width="100%" style="display:block; margin:0 auto;">
*Snap Line*
