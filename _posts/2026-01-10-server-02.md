...
categories: [Cloud, Oracle, CloudFlare]
...
<img src="assets/img/server/02/1.png" width="95%" style="display:block; margin:0 auto;">
*Virtual Cloud Network 화면*

Networking 메뉴에서 Virtual Cloud Networks로 이동한 뒤 현재 인스턴스가 연결된 VCN을 선택한다.

VCN 내부로 들어가면 보안 관련 항목이 보인다.

<img src="assets/img/server/02/2.png" width="95%" style="display:block; margin:0 auto;">
*Security 메뉴*

Security 항목으로 이동하면 Security Lists가 있다.  
이 리스트가 실제 인바운드와 아웃바운드 트래픽을 제어하는 역할을 한다.

<img src="assets/img/server/02/3.png" width="95%" style="display:block; margin:0 auto;">
*Security Lists*

현재 인스턴스가 연결된 Security List를 선택한 뒤 Security Rules 탭으로 들어간다.

<img src="assets/img/server/02/4.png" width="95%" style="display:block; margin:0 auto;">
*Ingress Rules 설정 화면*
