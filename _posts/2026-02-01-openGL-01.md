...
tags: [OpenGL, wallhack, z-buffer, depth-buffer, rendering-pipe, counter-strike ]
comments: true
---
...
<img src="assets/img/GameHacking/OpenGL/wallhack1.png" width="95%" style="display:block; margin:0 auto;">
*wallhack*
...
<img src="assets/img/GameHacking/OpenGL/zbuffer.png" width="95%" style="display:block; margin:0 auto;">
*Z-buffer*
...
<img src="assets/img/GameHacking/OpenGL/memory1.png" width="95%" style="display:block; margin:0 auto;">
*Memory*

<div style="display:flex; gap:10px;">
    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/OpenGL/beforedepth.png" width="100%">
        <p><em>GL_LEQUAL</em></p>
    </div>

    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/OpenGL/afterdepth.png" width="100%">
        <p><em>GL_ALWAYS</em></p>
    </div>
</div>
...
<img src="assets/img/GameHacking/OpenGL/glBegin1.png" width="95%" style="display:block; margin:0 auto;">
*glBegin() 호출부*
...
<div style="display:flex; gap:10px;">
    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/OpenGL/beforebegin.png" width="100%">
        <p><em>Before</em></p>
    </div>

    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/OpenGL/afterbegin.png" width="100%">
        <p><em>After</em></p>
    </div>
</div>
...
<div style="display:flex; gap:10px;">
    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/OpenGL/glBegin1.png"
             style="width:100%; height:350px; object-fit:contain;">
        <p><em>Before</em></p>
    </div>

    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/OpenGL/memory2.png"
             style="width:100%; height:350px; object-fit:contain;">
        <p><em>After</em></p>
    </div>
</div>
...
<div style="display:flex; gap:10px;">
    <div style="flex:1; text-align:center;">
        <img src="assets/img/GameHacking/OpenGL/hookok.png" width="100%">
        <p><em>hook</em></p>
    </div>
</div>
...
<img src="assets/img/GameHacking/OpenGL/GlassWall.png" width="100%" style="display:block; margin:0 auto;">
*GlassWall*
...
<img src="assets/img/GameHacking/OpenGL/chams.png" width="100%" style="display:block; margin:0 auto;">
*Chams*
...
<img src="assets/img/GameHacking/OpenGL/wireframe.png" width="100%" style="display:block; margin:0 auto;">
*wireframe*
...
<img src="assets/img/GameHacking/OpenGL/trans.png" width="100%" style="display:block; margin:0 auto;">
*Translucent*
