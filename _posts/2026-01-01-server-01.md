...
tags: [oracle-cloud, instance, ubuntu, vcn, ssh, reserved-public-ip]
comments: true
---

## 1. 인스턴스 생성

<img src="assets/img/server/01/1.png" width="95%" style="display:block; margin:0 auto;">
...
<img src="assets/img/server/01/2.png" width="95%" style="display:block; margin:0 auto;">
*Basic information*
...
<img src="assets/img/server/01/3.png" width="95%" style="display:block; margin:0 auto;">
*Networking*
...
<img src="assets/img/server/01/4.png" width="95%" style="display:block; margin:0 auto;">
*SSH*
...
<img src="assets/img/server/01/5.png" width="95%" style="display:block; margin:0 auto;">
*Instance*
...
<img src="assets/img/server/01/6.png" width="95%" style="display:block; margin:0 auto;">
*Reserved Public IPs*

공인 IP가 자동으로 할당되지 않았다면 Networking 메뉴에서 Reserved Public IPs로 이동한다.

<img src="assets/img/server/01/7.png" width="95%" style="display:block; margin:0 auto;">
*Reserved Public IPs*
...
<img src="assets/img/server/01/8.png" width="95%" style="display:block; margin:0 auto;">
*Attached VNICs*
...
<img src="assets/img/server/01/9.png" width="95%" style="display:block; margin:0 auto;">
*IP administration*

IP administration 탭으로 들어가면 현재 Private IP 정보가 표시된다.  
연결하고자 하는 네트워크 우측의 점 3개 옵션에 - Edit 을 클릭한다.  

<img src="assets/img/server/01/10.png" width="95%" style="display:block; margin:0 auto;">
...
<img src="assets/img/server/01/11.png" width="95%" style="display:block; margin:0 auto;">
*success*
