...
date: 2025-09-20 17:30:00 +0900
categories: [win32, WindowsAPI]
tags: [WinAPI, Memory, Scanner]
comments: true
---

PE 구조를 파일 기준으로만 보다가 실제 실행 중인 메모리에서는 어떤식으로 구성이 되어있는지 궁금해 만들게 되었다.   

자세한 소스코드와 내용은 [Github](https://github.com/Cryptonite7777/Memory-Module-Scanner){:target="_blank"} 을 참고하면 된다.
...
<img src="assets/img/Review/MemoryScanner/executable.png" width="95%" style="display:block; margin:0 auto;">
*실행 화면*
...
<img src="assets/img/Review/MemoryScanner/program_region.png" width="95%" style="display:block; margin:0 auto;">
<img src="assets/img/Review/MemoryScanner/my_region.png" width="95%" style="display:block; margin:0 auto;">
*모듈 정보*
...
<img src="assets/img/Review/MemoryScanner/result.png" width="95%" style="display:block; margin:0 auto;">
*패턴 탐지 결과 출력*
