...
tags: [cloudflare, ssl, tls, certbot, letsencrypt, nginx]
comments: true
---
...
<img src="assets/img/server/03/01.png" width="90%" style="display:block; margin:0 auto;">
*DNS 설정*
...
<img src="assets/img/server/03/02.png" width="90%" style="display:block; margin:0 auto;">
*DNS 레코드 등록 상태*
...
<img src="assets/img/server/03/03.png" width="90%" style="display:block; margin:0 auto;">
*Cloudflare SSL/TLS*
